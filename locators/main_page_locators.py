...
class LocatorQuestionAnswer:

        HEAD_OF_QUESTIONS = (By.XPATH, '//*[contains(text(),"Вопросы о важном")]')
...
class LocatorOrderButtonMainPage:

        ORDER_BUTTON_ON_HEADDER = (By.CSS_SELECTOR, "button[class*='Button_Button']")
        ORDER_BUTTON_SECOND = (By.XPATH, "(//button[text()='Заказать'])[2]")


class LocatorHeadderButton:

        YANDEX_LOGO = (By.CSS_SELECTOR, "img[alt='Yandex']")
        SCOOTER_LOGO = (By.CSS_SELECTOR, "img[alt='Scooter']")

        DZEN_HEADER = (By.XPATH, "//header")
